      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="hidden items-center space-x-8 md:flex">
            ...
            <Link to="/sale" className="text-sm font-medium transition-colors hover:text-primary">
              Sale
            </Link>
          </nav>
        ...
        {isMobileMenuOpen && (
          <nav className="flex flex-col space-y-4 border-t border-border/50 py-4 md:hidden">
            <Link to="/products" className="text-sm font-medium transition-colors hover:text-primary" onClick={() => setIsMobileMenuOpen(false)}>
              New Arrivals
            </Link>
            <Link to="/women" className="text-sm font-medium transition-colors hover:text-primary" onClick={() => setIsMobileMenuOpen(false)}>
              Women
            </Link>
            <Link to="/men" className="text-sm font-medium transition-colors hover:text-primary" onClick={() => setIsMobileMenuOpen(false)}>
              Men
            </Link>
            <Link to="/sale" className="text-sm font-medium transition-colors hover:text-primary" onClick={() => setIsMobileMenuOpen(false)}>
              Sale
            </Link>
          </nav>
        )}
