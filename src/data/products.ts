...
export const getMenProducts = () => allProducts.filter(p => p.gender === 'men' || p.gender === 'unisex');
export const getWomenProducts = () => allProducts.filter(p => p.gender === 'women' || p.gender === 'unisex');
